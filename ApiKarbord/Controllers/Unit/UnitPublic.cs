...
namespace ApiKarbord.Controllers.Unit
{
    public class UnitPublic
    {
        ...
        public static int VerNumber = 1037;
                ...
                sql = string.Format(CultureInfo.InvariantCulture,
                         @"DECLARE	@return_value nvarchar(50),
                          ...
                          EXEC	@return_value = {75}.[dbo].[Web_SaveFDoc_HU]
                            ...
                            head.AddMinSpec9,
                            head.AddMinSpec10,
                            Math.Abs((decimal)head.AddMinPrice1),
                            Math.Abs((decimal)head.AddMinPrice2),
                            Math.Abs((decimal)head.AddMinPrice3),
                            Math.Abs((decimal)head.AddMinPrice4),
                            Math.Abs((decimal)head.AddMinPrice5),
                            Math.Abs((decimal)head.AddMinPrice6),
                            Math.Abs((decimal)head.AddMinPrice7),
                            Math.Abs((decimal)head.AddMinPrice8),
                            Math.Abs((decimal)head.AddMinPrice9),
                            Math.Abs((decimal)head.AddMinPrice10),
                            head.InvCode,
                            head.Status,
                            head.PaymentType,
                            UnitPublic.ConvertTextWebToWin(head.Footer ?? ""),
